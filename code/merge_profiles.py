...
for i, plate_file in enumerate(os.listdir(profile_path)):
    ...
    df['Metadata_ASSAY_WELL_ROLE'] = df['Metadata_ASSAY_WELL_ROLE'].replace({'treated':'trt', 'mock':'control'})
    ...
    role_type_eq = (df['Metadata_ASSAY_WELL_ROLE'] == df['Metadata_broad_sample_type']).all()
